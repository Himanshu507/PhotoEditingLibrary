package com.himanshu.editlibrary.Oil;

import android.graphics.Rect;

public class olfilter extends WholeImageFilter {
    ...
    public int[] filterPixels(int width, int height, int[] inPixels, Rect transformedSpace) {
        int index = 0;
